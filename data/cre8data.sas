...
/* Create Excel workbook: <YYYY>M<MM>_emp_info_raw.xlsx using the macro above to name the file */
...
data xlout.leave;
	...
	LVBEGDTE=mdy(rand('uniform',1,4),day(LVBEGDTE),2026);	
